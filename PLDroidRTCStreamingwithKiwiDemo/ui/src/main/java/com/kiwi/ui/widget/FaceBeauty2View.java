...
public class FaceBeauty2View extends FrameLayout implements View.OnClickListener{
    ...
    public FaceBeauty2View(Context context) {
        super(context);
        init(null, 0);
    }

    public FaceBeauty2View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public FaceBeauty2View(Context context, AttributeSet attrs, int defStyle) {
